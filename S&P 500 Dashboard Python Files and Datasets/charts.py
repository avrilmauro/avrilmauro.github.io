...
def display_bubble_chart():
    ...
    fig.update_layout(xaxis_title='Percent Growth (2010 to 2022)',
                      yaxis_title=f'Average Closing Price (2022)',
                      title={'text': 'Stock Growth by Industry from 2010 to 2022',
